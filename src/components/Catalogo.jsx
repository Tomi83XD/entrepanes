...
function Cart({ cartItems, onClose, onRemoveItem, onClearCart, onIncreaseQty, onDecreaseQty }) {
  const [step, setStep] = useState('view'); // 'view' or 'payment'
              ...
              <>
                ...
                >
                  {cartItems.map(({ id, name, price, quantity, image }) => (
                    <li key={id} className="py-4 flex gap-4 items-center" role="listitem">
                      <img
                        src={image}
                        alt={name}
                      ...
                      <button
                        ...
                        className="text-red-500 hover:text-red-400 font-bold self-start select-none"
                      >
                        ✕
                      </button>
                    </li>
                  ...
                  <>
                    ...
                    {paymentMethod === 'transferencia' ? (
                      <p className="mt-2 text-yellow-300 select-none">
                        ...
                        Alias: <span className="font-mono">tomas.hornalla</span><br />
                        Titular: Tomas Martn Orellana Jimenez<br />
                        Sacale captura de pantalla a el pedido!
                        Manda esa captura y el comprobante a el siguiente WhatsApp!!
                      </p>
                    ) : (
                      <p className="mt-2 text-yellow-300 select-none">
                        El pago será realizado en efectivo al momento de la entrega en caja.<br />
                        PAGO CON TRANSFERENCIA %10 DESCUENTO!!!
                        Mandar captura del pedido al siguiente WhatsApp
                      </p>
                    )}

                    {paymentMethod === 'transferencia' && (
                      <a
                        href="https://wa.me/3541682299"
                        target="_blank"
